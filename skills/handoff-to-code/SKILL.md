...
The fifth, optional input is the operator's lock table: rulings **on top of** the pair,
carrying only what the file cannot — blend modes, behaviour, links, copy overrides.
