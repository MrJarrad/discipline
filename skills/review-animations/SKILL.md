...
description: Reviews animation and motion code against a high craft bar — flags feel-breaking regressions (wrong easing, comes-from-nowhere entrances, non-GPU properties, animation on high-frequency actions) and reaches an explicit Block/Approve decision. Default to flagging; approval is earned.
---

# Reviewing Animations

Read [references/DOS-AND-DONTS.md](references/DOS-AND-DONTS.md) before reviewing.

A specialized review skill. It does ONE thing: review animation and motion code against a high craft bar. It does not write features, fix unrelated bugs, or review non-motion code. If asked to review general code, decline and point to a general code-review skill instead.
