...
description: Anti-slop taste skill for shipping landing pages, portfolios, and redesigns that don't look templated — infers design direction from the brief and audits redesigns first. Use when building or redesigning a marketing/portfolio surface with no existing design system to follow. Not for dashboards, data tables, or multi-step product UI, and not for applying an existing token/component contract — that's design-craft.
---
