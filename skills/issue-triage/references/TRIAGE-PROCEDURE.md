# issue-triage — the ready-for-agent bar, the brief template and the redirect rules in full

SKILL.md keeps the two rules that stop a bad lane opening; this file is the full bar, the categorization and verification steps, the agent-brief template, the out-of-scope knowledge base, redirect rules and the five intake buckets. Nothing here was rewritten — it is the 1.78.0 body, moved.
