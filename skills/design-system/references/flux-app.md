...
## Motion conventions (see also design-eng)
...
Match design-eng's decision framework when adding motion — most repeated actions
...
/ `--duration-*` tokens. design-eng prescribes named easing curves — promote them
