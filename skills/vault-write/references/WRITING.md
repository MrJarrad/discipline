# vault-write — how to write, and the typed kinds in full

SKILL.md keeps the placement decision, the frontmatter law and the gate; this file is the full writing guidance, every typed kind within a thing, graph wiring, naming, the canonical schema and typed references. Nothing here was rewritten — it is the 1.78.0 body, moved.
