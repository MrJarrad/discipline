# banana — Claude as Creative Director, in full

SKILL.md keeps the mandatory reads, the core principle and the command surface; this file is the full creative-direction method, the editing workflows and the error-handling catalogue. Nothing here was rewritten — it is the 1.78.0 body, moved.
