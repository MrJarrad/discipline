# prompt-craft — both altitudes and the slicing rule in full

SKILL.md keeps the one rule, the altitude choice and the mechanism rule; this file is the shared foundations, both altitude templates in full, the skills-not-around-them guidance, the good-vs-bad test and the vertical-slicing rule. Nothing here was rewritten — it is the 1.78.0 body, moved.
