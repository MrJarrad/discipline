# Motion — vocabulary glossary

The reverse-lookup lane behind `motion`'s Vocabulary section: quote these descriptions
verbatim; they are authoritative. SKILL.md keeps the trigger and the answer format.
Nothing here was rewritten — it is the 1.78.0 Vocabulary section, moved.
