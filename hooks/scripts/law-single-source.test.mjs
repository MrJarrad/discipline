...
const LAWS = [
  ...
  {
    // 1.81.0: the cap dropped from three rounds to one-plus-a-red-round
    // (`lean-lane-cadence-2026-09-16`). The law moved value, not home.
    law: "the review round cap",
    home: "agents/reviewer.md",
    definition: "**One review round is the default; hard\ncap: 2 review rounds per change.**",
    elsewhere: /hard cap: \d+ review rounds|there is no round [34]/i,
    pointer: "`agents/reviewer.md` § Round cap",
    pointedFrom: ["agents/engineer.md", "output-styles/discipline.md", "skills/routing/SKILL.md", "skills/wrap/SKILL.md", "skills/dispatch-brief/SKILL.md"],
  },
  {
    law: "the operator queue printed in full on every status",
    home: "output-styles/discipline.md",
    definition: '**Every status reply ends with "Needed from you" — the operator queue, in full.**',
    elsewhere: /every status reply ends with "Needed from you"/i,
    pointer: "`orchestrator/operator-queue.md`",
    pointedFrom: ["skills/wrap/SKILL.md", "skills/pause-resume/SKILL.md", "skills/present-for-review/SKILL.md", "skills/routing/SKILL.md"],
  },
  {
    law: "the operator is the cheapest visual gate",
    home: "doer-rules.md",
    definition: "**The operator is the cheapest visual gate.**",
    elsewhere: /\*\*The operator is the cheapest visual gate\.\*\*/,
    pointer: "the operator is the cheapest visual gate",
    pointedFrom: ["skills/dispatch-brief/SKILL.md", "skills/prototype/SKILL.md", "skills/present-for-review/SKILL.md"],
  },
  {
    law: "one worktree name per lane",
    home: "doer-rules.md",
    definition: "**One worktree name per lane, and you remove only your own.**",
    elsewhere: /one worktree name per lane/i,
    pointer: "lane-named worktree",
    pointedFrom: ["skills/dispatch-brief/SKILL.md"],
  },
  {
    law: "touched gates per row, one full suite per lane",
    home: "doer-rules.md",
    definition: "**Touched gates per row; one full suite per lane.**",
    elsewhere: /touched gates per row/i,
    pointer: "`doer-rules.md` § Repo and safety",
    pointedFrom: ["agents/engineer.md"],
  },
  {
